  ...
  TranquilBrowserView.content = function (params) {
    ...
    this.div({ class: "tranquil-browser" }, () => {
        ...
        () => {
          ...
          this.div({ class: "nav-btns-bc" }, () => {
            this.div({ class: "nav-btns-right-bc" }, () => {
              ...
              this.span({ class: "apm-browser-icon-divider" }, "");
              this.span(
                { id: "fav", class: "apm-browser-icon-wrapper", outlet: "fav" },
                () => { this.img({ class: "apm-browser-icon", src: _icon("star") }); }
              );
              this.span({ class: "apm-browser-icon-divider" }, "");
              this.span(
      ...
      this.tag("webview", {
        ...
        outlet: "htmlv",
        preload: `file:///${params.tranquilBrowser.resources}/bp-client.js`,
        plugins: "on",
        src: `${url}`,
