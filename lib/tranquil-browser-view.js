  ...
  TranquilBrowserView.prototype.initialize = function () {
    ...
    src = (function (_this) {
      return function (req, res) {
        var fav, pattern, searchUrl, urls, view;
        view = _this; // the success handler below shadows `_this`, so capture it
            ...
            success: (function (_this) {
              return function (data) {
                ...
                for (i = 0, len = ref1.length; i < len; i++) {
                  ...
                  // searches. `label` stays the suggestion text; `value` is where
                  // selecting it navigates.
                  urls.push({
                    label: dat,
                    value: view.suggestionTarget(dat),
                  });
                }
                return res(urls);
              };
